  ...
  pt: {
    ...
    experience: {
      ...
      items: [
        ...
        ['Setor público', '2020 - 2022', 'Prefeitura de Goiânia | Cast Group', 'OutSystems, C#, licitação e Scrum', 'Sustentação e evolução de sistemas públicos com regras de licitação, processos complexos, dailies, planejamento, documentação e organização de atividades.'],
  ...
  en: {
    ...
    experience: {
      ...
      items: [
        ...
        ['Public sector', '2020 - 2022', 'Goiânia City Hall | Cast Group', 'OutSystems, C#, procurement rules and Scrum', 'Support and evolution of public-sector systems with procurement rules, complex processes, dailies, planning, documentation and task organization.'],
